...
class fault_grab():
    ...
    # action function for each color
    ...
    def check_position_cv(self, tolerance: int = 25) -> bool:
        ...
        box = np.int0(box) 
        cv2.drawContours(debug_img, [box], 0, (0, 255, 255), 2) # yellow box
