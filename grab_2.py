...
class fault_grab():
    def __init__(self, capture_source):
        ...
        self.p_Yellow = [70, 70, 14, 30, 270]
        self.p_Red = [112, 70, 13, 33, 270]
        ...
        self.p_Green_check = [136, 86, 20, 0, 90]
    ...
    def number_action(self, index): 
        ...
        pos_ok   = self.check_position_cv(tolerance=120)
    ...
    def get_color(self, img):
        ...
        if H_min == 0 and H_max == 179 and (150 <= S_mean <= 190):
            color_name['name'] = 'red'
        elif H_min >= 22 and H_max <= 34:
            color_name['name'] = 'yellow'
        elif (H_min >= 35 and H_max <= 78) and (90 <= S_mean <= 130):
